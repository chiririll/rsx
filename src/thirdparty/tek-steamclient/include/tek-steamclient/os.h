...
#elif defined(__linux__) // def _WIN32
...
#elif defined(__APPLE__) // def _WIN32 elif defined(__linux__)
...
#else // def _WIN32 elif defined(__linux__) elif defined(__APPLE__)

#error Unsupported target OS. Only Windows (_WIN32), Linux (__linux__) and \
  MacOS (__APPLE__) are supported.

#endif // def _WIN32 elif defined(__linux__) elif defined(__APPLE__) else
